...
export const LogoIcon: React.FC<IconProps> = (props) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M9.5 13.75C9.5 12.09 10.59 11 12 11C13.41 11 14.5 12.09 14.5 13.75M9.5 13.75C9.5 15.41 8.41 16.5 7 16.5C5.59 16.5 4.5 15.41 4.5 13.75C4.5 12.09 5.59 11 7 11C8.41 11 9.5 12.09 9.5 13.75ZM9.5 13.75V9.75M14.5 13.75C14.5 15.41 15.59 16.5 17 16.5C18.41 16.5 19.5 15.41 19.5 13.75C19.5 12.09 18.41 11 17 11C15.59 11 14.5 12.09 14.5 13.75ZM14.5 13.75V9.75M12 11V9.75M12 9.75C12 7.79 10.21 6.5 8 6.5C5.79 6.5 4 7.79 4 9.75M12 9.75C12 7.79 13.79 6.5 16 6.5C18.21 6.5 20 7.79 20 9.75M8 6.5C8 5.5 8.5 4 12 4C15.5 4 16 5.5 16 6.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
);
...
export const GoogleIcon: React.FC<IconProps> = (props) => (
    <svg {...props} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
      ...
      <path fill="#FF3D00" d="M6.306 14.691l6.057 4.704c1.647-3.951 5.331-6.722 9.637-6.722c3.059 0 5.842 1.154 7.961 3.039l5.657-5.657C34.046 6.053 29.268 4 24 4C16.318 4 9.656 8.337 6.306 14.691z"/>
      <path fill="#4CAF50" d="M24 44c5.166 0 9.86-1.977 13.409-5.192l-6.19-4.823A11.952 11.952 0 0124 36c-5.222 0-9.613-3.27-11.284-7.77l-6.082 4.706C9.574 39.108 16.221 44 24 44z"/>
      <path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303c-.792 2.237-2.231 4.166-4.087 5.571l6.19 4.823c3.424-3.181 5.59-7.745 5.59-12.812c0-1.341-.138-2.65-.389-3.917z"/>
    </svg>
  );