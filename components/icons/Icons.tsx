...
export const LogoIcon: React.FC<IconProps> = (props) => (
    <svg {...props} viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
            <linearGradient id="brain-gradient" x1="128" y1="20" x2="128" y2="236" gradientUnits="userSpaceOnUse">
                <stop stopColor="#4ADE80"/> 
                <stop offset="0.5" stopColor="#3B82F6"/>
                <stop offset="1" stopColor="#2563EB"/>
            </linearGradient>
        </defs>
        <path d="M168,72a24,24,0,0,0-41.6-16,23.9,23.9,0,0,0-44.8,8,24,24,0,0,0-16,40,24,24,0,0,0,16,8,23.9,23.9,0,0,0,16-32,24,24,0,0,0,16-24,24,24,0,0,0,16,0,24.2,24.2,0,0,0,16,24,23.9,23.9,0,0,0,16,32,24,24,0,0,0,16-8A24,24,0,0,0,168,72Z" fill="url(#brain-gradient)"/>
        <path d="M128,128v88a40.1,40.1,0,0,1-40-40,40,40,0,0,1,16-32,39.9,39.9,0,0,1,48,0,40,40,0,0,1,16,32A40.1,40.1,0,0,1,128,216Z" fill="url(#brain-gradient)"/>
        <path d="M168,72c0-13.2-10.8-24-24-24s-24,10.8-24,24a24,24,0,0,0,48,0Z" fill="url(#brain-gradient)"/>
        <path d="M88,72c0-13.2-10.8-24-24-24s-24,10.8-24,24a24,24,0,0,0,48,0Z" fill="url(#brain-gradient)"/>
        <path d="M112,120a16,16,0,1,0-16-16A16,16,0,0,0,112,120Z" fill="url(#brain-gradient)"/>
        <path d="M160,120a16,16,0,1,0-16-16A16,16,0,0,0,160,120Z" fill="url(#brain-gradient)"/>
        <path d="M80,144a16,16,0,1,0-16-16A16,16,0,0,0,80,144Z" fill="url(#brain-gradient)"/>
        <path d="M176,144a16,16,0,1,0-16-16A16,16,0,0,0,176,144Z" fill="url(#brain-gradient)"/>
        
        <path d="M168,72a24,24,0,0,0-41.6-16,23.9,23.9,0,0,0-44.8,8,24,24,0,0,0-16,40,24,24,0,0,0,16,8,23.9,23.9,0,0,0,16-32,24,24,0,0,0,16-24,24,24,0,0,0,16,0,24.2,24.2,0,0,0,16,24,23.9,23.9,0,0,0,16,32,24,24,0,0,0,16-8A24,24,0,0,0,168,72Z" stroke="#0F172A" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M128,128v88a40.1,40.1,0,0,1-40-40,40,40,0,0,1,16-32,39.9,39.9,0,0,1,48,0,40,40,0,0,1,16,32A40.1,40.1,0,0,1,128,216Z" stroke="#0F172A" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M128,24V56" stroke="#0F172A" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M128,56a16,16,0,0,1-16,16" stroke="#0F172A" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M100,52a20,20,0,0,0-12,20" stroke="#0F172A" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M156,52a20,20,0,0,1,12,20" stroke="#0F172A" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M80,96a24,24,0,0,0-16,8" stroke="#0F172A" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M176,96a24,24,0,0,1,16,8" stroke="#0F172A" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M128,128a24,24,0,0,1-24,24" stroke="#0F172A" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M128,128a24,24,0,0,0,24,24" stroke="#0F172A" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M104,152v24" stroke="#0F172A" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M152,152v24" stroke="#0F172A" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
);
